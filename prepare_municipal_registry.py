...
# Add new registry entries first. Later runs may already have status overrides
# for sources that were originally introduced through this patch file.
...
# Apply status/configuration overrides only after all additions exist.

...
# These statuses mean the source is present, but the source/adapter decision is
# still intentionally provisional. They are the next validation queue.
REVIEW_STATUSES = {
    "active_test",
...
def main():
    ...
    print(f"Paused sources     : {len(sources) - enabled_count}")
